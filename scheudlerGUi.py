...
class Ui_MainWindow(QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.graph_label.setGeometry(QtCore.QRect(20, 10, 791, 391)) #set the size and location of the graph label
        ...
        self.pushButton.setGeometry(QtCore.QRect(270, size.height()-200, 281, 51)) #set the size and location of the push button
    ...
    def schedule(MainWindow):
        ...
        if not arrival:
            ...
            arrival_arr = [int(i) for i in arrival.split(" ")]
        ...
        if not time_quant:
            ...
            time_quant_arr = [int(i) for i in time_quant.split(" ")]
